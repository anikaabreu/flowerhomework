...
class BeachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beach" do
    assert_difference('Beach.count') do
      post beaches_url, params: { beach: { coordinates: @beach.coordinates, description: @beach.description } }
    end
  ...
  test "should update beach" do
    patch beach_url(@beach), params: { beach: { coordinates: @beach.coordinates, description: @beach.description } }
